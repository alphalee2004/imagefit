  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6">
      ...
      <div className="mt-8 space-y-6 text-gray-700">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900">2. Your content</h2>
          <p className="mt-2 text-base leading-7">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900">3. No warranty</h2>
          <p className="mt-2 text-base leading-7">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900">4. Changes</h2>
          <p className="mt-2 text-base leading-7">
